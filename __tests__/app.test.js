...
describe('GET /api/articles/:article_id', () => {
  test('Responds with an article including the comment_count', () => {
    return request(app)
      .get('/api/articles/1')
      .expect(200)
      .then(({ body }) => {
  ...
  test('200: Responds with comment_count as 0 for articles with no comments', () => {
    return request(app)
      .get('/api/articles/2')
      .expect(200)
      .then(({ body }) => {
        expect(body.articles.comment_count).toBe(0);
      });
  });
